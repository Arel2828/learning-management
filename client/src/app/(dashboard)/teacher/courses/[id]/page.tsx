...
const CourseEditor = () => {
  ...
  const handleImageUpload = async (file: File) => {
    ...
    try {
      ...
      // Do something with the uploaded image URL (e.g., save it to your course)
    } catch (error) {
          ...
          <div className="flex justify-between md:flex-row flex-col gap-10 mt-5 font-dm-sans">
            <div className="basis-1/2">
              <div className="space-y-4">
                ...
                {/* Add Image Button Below Course Price */}
                <div className="mt-4">
                  <Button
                    type="button"
                    variant="outline"
                  ...
                  {image && (
                    <div className="mt-2">
                      ...
                      <img
                        src={URL.createObjectURL(image)} // If the user uploads an image
                        alt="Selected"
...
// import { Button } from "@/components/ui/button";
// import { Form, FormProvider, useForm } from "@/components/ui/form"; // Using FormProvider
// import { courseSchema } from "@/lib/schemas";
...
// } from "@/components/ui/dialog";
// import { Input } from "@/components/ui/input";
// import { Pencil, Archive, Plus } from "lucide-react"; // Importing icons for editing, archiving, and adding

// const CourseEditor = () => {
//   const methods = useForm(); // Define methods using useForm
//   interface Category {
//     value: string;
//     label: string;
//     archived?: boolean;
...
//     // Get categories from localStorage if available
...
//     setNewCategory(categories[index].label);
//   };
...
//       if (editingCategory) {
//         updatedCategories[
//           categories.findIndex((cat) => cat.value === editingCategory.value)
//         ] = {
//           value: newCategory.trim(),
//           label: newCategory.trim(),
//         };
...
//   const handleArchiveCategory = (index: number) => {
//     const archivedCategories = [...categories];
//     archivedCategories[index].archived = true;
//     setCategories(archivedCategories);
//   };
...
//             type="select"
//             placeholder="Select category here"
//             options={categories.filter((cat) => !cat.archived)} // Only show non-archived categories
//             className="flex-1"
//           />
//           <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
//             <DialogTrigger asChild>
...
//                   variant="outline"
//                   size="sm"
//                   onClick={() => handleArchiveCategory(index)}
//                 >
